<template>
      ...
      <div class="creation-form">
        <div class="left-panel">
          <div class="form-group">
            ...
            <textarea id="prompt" v-model="prompt" rows="5" placeholder="Describe the music you want to create (e.g., '80s synthwave track with driving bassline')..."></textarea>
          </div>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="native-genre">Native Genre (Liste):</label>
             <p style="font-size: 0.8em; color: grey;">(Unklar, was hier gemeint ist - evtl. Subgenre? Vorerst wie oben)</p>
  ...
  .creation-form {
    display: flex;
    gap: 30px; /* Abstand zwischen Formular und Bild */
  }
